...
testData={"A":{'HP1': 0.66, 'HP2' : 0.00,  'HP3': 0.00, 'TW': 1.66, 'SW1': -2.33 , 'SW2': 0, 'SW3': 0},
          "B":{'HP1': 0.33, 'HP2' : 0.33, 'HP3':-0.66, 'TW': 0,     'SW1': 0 ,   'SW2': 0, 'SW3': 0},
          "C":{'HP1': 0.00, 'HP2' : 0.00, 'HP3': 0.00, 'TW': -1.66, 'SW1': 0.33, 'SW2': 1.33, 'SW3':0},
          "D":{'HP1': 0.00, 'HP2' : 0.00, 'HP3': 0.00, 'TW': 0.00, 'SW1': 0.00, 'SW2': 0.00, 'SW3':0.00}}

def test():
     recomEngine = RecommendationEngine()
     print ('Cosine similarity between A & C ',recomEngine.getCosineSimilarityOfPairOfUsers(testData,'A','C'))
     print ('Cosine similarity between A & B ',recomEngine.getCosineSimilarityOfPairOfUsers(testData,'A','B'))
